        ...
        <div v-loading="loadding">
            ...
            >
                    ...
                    <el-form-item label="评论内容" prop="content">
                        <el-input v-model="formData.content" :disabled="title=='回复评论'" maxlength="100" clearable show-word-limit type="textarea" />
                    </el-form-item>
                    <el-form-item label="回复内容" prop="reply">
                        <el-input v-model="formData.reply" placeholder="请输入回复内容" maxlength="100" clearable show-word-limit type="textarea" />
                    </el-form-item>
