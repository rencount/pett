    ...
    <el-card shadow="hover">
      <div class="header-section">
        ...
        <div class="action-buttons">
            <el-button v-if="isAuth('xuexiguanli','新增')" icon="ele-Plus" type="primary" @click="add()">新增</el-button>
            <el-button v-if="isAuth('xuexiguanli','删除')" icon="ele-Delete" @click="listdel()" :disabled="isdel" type="danger" plain>批量删除</el-button>
                                                </div>
      </div>
       <div class="query-section">
         <el-form :model="query" inline>
                                                                                                        <el-form-item label="标题">
                        <el-input v-model="query.biaoti" maxlength="100" placeholder="请输入标题" clearable/>
                    </el-form-item>
                                                                                                                                                                                                                                                                                                    <el-form-item>
