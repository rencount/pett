      ...
      <div class="rounded-xl bg-white p-8 shadow-lg">
        ...
        <div class="mb-12 flex gap-12">
          ...
          <div class="w-3/5">
                                                                ...
                                                                <h1 class="mb-6 text-4xl font-bold text-gray-900">{{detail.zhengzhuang}}</h1>
                                                                <h1 class="mb-6 text-4xl font-bold text-gray-900">{{detail.zhiliaojianyi}}</h1>
                ...
                <span class="text-gray-600">{{detail.chongwumingcheng}}</span>
                                        ...
                                        <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">症状：</span>
                <span class="text-gray-600">{{detail.zhengzhuang}}</span>
              </div>
                                        <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">治疗建议：</span>
                <span class="text-gray-600">{{detail.zhiliaojianyi}}</span>
              </div>
                                        <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">诊断时间：</span>
                <span class="text-gray-600">{{detail.zhenduanshijian}}</span>
              </div>
                                        <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">诊断人：</span>
                <span class="text-gray-600">{{detail.zhenduanren}}</span>
              </div>
                                        <div class="flex items-center gap-2">
