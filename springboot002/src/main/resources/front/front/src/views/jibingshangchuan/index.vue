            ...
            const params={
                ...
                limit: state.page.size,
                        ...
                        params['chongwumingcheng'] = '%' + state.searchForm.chongwumingcheng + '%'
                                                                ...
                                                                if (state.searchForm.bingqingmiaoshu != '' && state.searchForm.bingqingmiaoshu != undefined) {
                        params['bingqingmiaoshu'] = '%' + state.searchForm.bingqingmiaoshu + '%'
                    }
                                                                                                                        if (state.searchForm.fabushijian != '' && state.searchForm.fabushijian != undefined) {
                        params['fabushijian'] = '%' + state.searchForm.fabushijian + '%'
                    }
  ...
  <div>
    ...
    <div class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-4">疾病上传</h2>
