        ...
        <div class="mb-12 flex gap-12">
          ...
          <div class="w-3/5">
                ...
                <span class="text-gray-600">{{detail.xingbie}}</span>
                                        ...
                                        <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">喜好：</span>
                <span class="text-gray-600">{{detail.xihao}}</span>
              </div>
                                        <div class="flex items-center gap-2">
            ...
            if (data.data.list.length == 1) {
                ...
                request({
                    ...
                    data:{
                        refid: state.detail.id,
                        tablename: state.detailTable,
                           name: state.detail.chongwumingcheng,
                                  userid:state.user.id,
