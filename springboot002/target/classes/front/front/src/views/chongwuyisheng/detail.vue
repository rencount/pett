    ...
    <div class="mx-auto max-w-7xl p-8">
      <div class="rounded-xl bg-white p-8 shadow-lg">
        ...
        <div class="mb-12 flex gap-12">
          ...
          <div class="w-3/5">
                                                                                                                            <h1 class="mb-6 text-4xl font-bold text-gray-900">{{detail.zhanghao}}</h1>
                                                                                                      <h1 class="mb-6 text-4xl font-bold text-gray-900">{{detail.mima}}</h1>
                                                                                                                                                           <div class="mb-6 space-y-2">
                                                  <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">账号：</span>
                <span class="text-gray-600">{{detail.zhanghao}}</span>
              </div>
                                                        <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">密码：</span>
                <span class="text-gray-600">{{detail.mima}}</span>
              </div>
                                        <div class="flex items-center gap-2">
                ...
                <span class="text-gray-600">{{detail.lianxifangshi}}</span>
                                        ...
                                        <div class="flex items-center gap-2">
                <span class="font-bold text-gray-700">昵称：</span>
                <span class="text-gray-600">{{detail.nicheng}}</span>
              </div>
                                  </div>
        ...
        <!-- 详情区 -->
        <div class="mt-12 rounded-lg bg-gray-50 p-8" v-if="detail.xiangqing">
          <div class="prose prose-lg max-w-none" v-html="detail.xiangqing">
