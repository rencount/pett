    ...
    <el-card shadow="hover">
      <div class="header-section">
        ...
        <div class="action-buttons">
            <el-button v-if="isAuth('zixun','新增')" icon="ele-Plus" type="primary" @click="add()">新增</el-button>
            <el-button v-if="isAuth('zixun','删除')" icon="ele-Delete" @click="listdel()" :disabled="isdel" type="danger" plain>批量删除</el-button>
                                                </div>
      </div>
       <div class="query-section">
         <el-form :model="query" inline>
                                                                                                        <el-form-item label="宠物医生">
                        <el-input v-model="query.chongwuyisheng" maxlength="100" placeholder="请输入宠物医生" clearable/>
                    </el-form-item>
      ...
      <el-table
        ...
        <el-table-column type="selection" width="55" align="center"/>
              ...
              <template #default="{row}">
                                                      <el-button v-if="isAuth('zixun','修改')" icon="ele-Edit" @click.stop="handleEdit(row)" type="primary" link>修改</el-button>
                  <el-popconfirm  v-if="isAuth('zixun','删除')"  width="auto" @confirm="handleDelete(row)"  :title="`确定要删除这条记录吗？`">
                      <template #reference>
